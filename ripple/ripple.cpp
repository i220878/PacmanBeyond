// I spent 5 hours across forums and GLSL documentation to try and get this to work.
// Finally, it worked.
// This is here for reference in case me or anyone else needs to use a Shader with SFML in the future.
